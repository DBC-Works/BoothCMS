...
class Booth {
	...
	protected function get_pages($base_url, $order_by = 'alpha', $order = 'asc', $excerpt_length = 50)
	{
		...
		foreach($pages as $key=>$page){
			...
			$data = array(
				...
				// 2014-08-31 Customized by Sad Juno
	 ...
	 */
	protected static function get_protocol()
	{
		$protocol = 'http';
	 ...
	 */ 
	protected static function limit_words($string, $word_limit)
	{
		// 2014-08-31 Customized by Sad Juno
	//	$words = explode(' ',$string);
		$words = explode(' ',mb_eregi_replace('。', '。 ', mb_eregi_replace('、', '、 ', $string)));
